...
import { Search, MessageSquarePlus, Users, MoreVertical, LogOut, Archive } from 'lucide-react';
...
export function ChatList({ conversations, activeId, onSelect, onNewChat, onNewGroup, onProfile }: ChatListProps) {
